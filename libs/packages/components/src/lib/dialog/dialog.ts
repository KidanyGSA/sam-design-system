...
import { SdsDialogContainer, _SdsDialogContainerBase } from './dialog-container.component';
 ...
 */
@Directive()
export abstract class _SdsDialogBase<C extends _SdsDialogContainerBase> implements OnDestroy {
  ...
  constructor(
    ...
    private _defaultOptions: SdsDialogConfig | undefined,
    private _parentDialog: _SdsDialogBase<C> | undefined,
    private _overlayContainer: OverlayContainer,
    scrollStrategy: any,
    private _dialogRefConstructor: Type<SdsDialogRef<any>>,
   ...
   */
  private _attachDialogContainer(overlay: OverlayRef, config: SdsDialogConfig): C {
...
/**
 * Service to open Sdserial Design modal dialogs.
 */
@Injectable()
export class SdsDialog extends _SdsDialogBase<SdsDialogContainer> {
  constructor(
    overlay: Overlay,
    injector: Injector,
    /**
    ...
    @Optional() @Inject(SDS_DIALOG_DEFAULT_OPTIONS) defaultOptions: SdsDialogConfig,
    @Inject(SDS_DIALOG_SCROLL_STRATEGY) scrollStrategy: any,
    @Optional() @SkipSelf() parentDialog: SdsDialog,
    overlayContainer: OverlayContainer) {
    super(overlay, injector, defaultOptions, parentDialog, overlayContainer, scrollStrategy,
      SdsDialogRef, SdsDialogContainer, SDS_DIALOG_DATA);
  }
}
