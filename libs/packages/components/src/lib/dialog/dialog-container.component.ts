...
/**
 * Base class for the `SdsDialogContainer`. The base class does not implement
 * animations as these are left to implementers of the dialog container.
 */
@Directive()
export abstract class _SdsDialogContainerBase extends BasePortalOutlet {
...
export class SdsDialogContainer extends _SdsDialogContainerBase {
