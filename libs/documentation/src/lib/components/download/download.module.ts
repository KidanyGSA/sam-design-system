...
import { FormlyDialog } from './demos/formly/formly-modal.component';
import { FormlyDialogModule } from './demos/formly/formly-modal.module';
...
const DEMOS = {
  formly: {
    ...
    type: FormlyDialog,
    code: require('!!raw-loader!./demos/formly/formly-modal.component'),
    markup: require('!!raw-loader!./demos/formly/formly-modal.component.html'),
    path: 'libs/documentation/src/lib/components/download/demos/formly'
  },
  download: {
