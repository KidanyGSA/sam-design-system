...
const DEMOS = {
  basic: {
    ...
    path:
      'libs/documentation/src/lib/components/formly/formly-multicheckbox/demos/basic'
  },
  selectall: {
    ...
    path:
      'libs/documentation/src/lib/components/formly/formly-multicheckbox/demos/selectall'
  },
  expandable: {
    ...
    path:
      'libs/documentation/src/lib/components/formly/formly-multicheckbox/demos/expandable'
  }
};
