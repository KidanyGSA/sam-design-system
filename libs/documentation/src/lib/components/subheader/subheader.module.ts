...
import { SubheaderTier2WorkspaceComponent } from './demos/tier2workspace/subheader-tier-2-workspace.component';
import { SubheaderTier2WorkspaceModule } from './demos/tier2workspace/subheader-tier-2-workspace.module';
...
const DEMOS = {
  ...
  dataentry: {
    ...
    path: 'libs/documentation/src/lib/components/subheader/demos/subheader/dataentry'
  },
  search: {
    title: 'Search',
  ...
  tier2workspace: {
    ...
    code: require('!!raw-loader!./demos/tier2workspace/subheader-tier-2-workspace.component'),
    markup: require('!!raw-loader!./demos/tier2workspace/subheader-tier-2-workspace.component.html'),
    path: 'libs/documentation/src/lib/components/subheader/demos/tier2workspace'
  }
};
